package br.com.carloscorp.dashcard.model;
...
public class Transacao {
	...
	@ManyToOne // indica que é uma correspondencia de mts pra 1
	@JoinColumn(name = "ag_financeiro") // indica qual coluna de Agente Financeiro correste a essa chave
